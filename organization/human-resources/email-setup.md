---
url: 'https://handbook.syslifters.com/organization/human-resources/email-setup.md'
description: >-
  Configure email encryption (S/MIME) and legally required signatures/footers
  for eM Client, Nextcloud Mail, and Thunderbird. Configure Nextcloud calendar
  to use within eM Client.
---
...
To use your nextcloud calendar you need to setup an additional account next to your mail configuration.

### eM Client

Start adding a new account by clicking the burger menu on the top left and click accounts.

![Add account (1)](/images/calendarConfig_eM-Client-add-Account1.png)

In the new window select add account, click on calendar and pick CalDav before hitting the next button.

![Add account (2)](/images/calendarConfig_eM-Client-add-Account2.png)

Insert the account address <https://cloud.syslifters.com/remote.php/dav> add your Nextcloud app password and click next and finish.

![Add account (3)](/images/calendarConfig_eM-Client-add-Account3.png)

If you do not have an app password for calendar sync already you can create one in your personal Nextcloud account. After signing in to <https://cloud.syslifters.com/> click on your profile picture, select settings, follow to security, enter a name for your app-password and confirm with create new app password.

![Create app password in Nextcloud for calendar sync](/images/calendarConfig_eM-Client-createAppPassword.png)

#### Change default calendar folder

To save email invitation events in the Nextcloud calendar you need to change the default calendar location in eM Client.

Click the burger menu and select accounts.
![Change default calendar folder (1)](/images/calendarConfig_eM-Client-change-default-folder1.png)

Pick your mail account, look for Default folders and select the Nextcloud calendar you added before.

![Change default calendar folder (2)](/images/calendarConfig_eM-Client-change-default-folder2.png)
